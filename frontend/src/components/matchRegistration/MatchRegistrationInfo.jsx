...
const MatchRegistrationInfo = ({ match }) => {
    ...
    // registered už vlastně ani nepotřebuješ, ale když tak:
        ...
        <div className="match-reg-info">
            ...
            <div className="match-reg-team-col">
                ...
                <ul className="match-reg-player-list">
                    {unregisteredPlayers.length === 0 && (
                        <li className="match-reg-player-empty">nikdo se neodhlásil</li>
                    )}
            ...
            <div className="match-reg-team-col">
                ...
                <ul className="match-reg-player-list">
                    {reservedPlayers.length === 0 && (
                        <li className="match-reg-player-empty">žádný náhradník</li>
                    )}
         ...
         <div className="match-reg-other-col"></div>
            ...
            <div className="match-reg-team-col">
                ...
                <ul className="match-reg-player-list">
                    {noActionPlayers === 0 && (
                        <li className="match-reg-player-empty">všichni reagovali</li>
                    )}
